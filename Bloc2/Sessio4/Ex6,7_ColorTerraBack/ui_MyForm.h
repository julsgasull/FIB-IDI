...
"color: white;"));
    ...
    void retranslateUi(QWidget *MyForm)
    {
        ...
        groupBox->setTitle(QApplication::translate("MyForm", "Color del Terra (R, G, B)", nullptr));
        label->setText(QString());
        groupBox_2->setTitle(QApplication::translate("MyForm", "Color del Fons (R, G, B)", nullptr));
