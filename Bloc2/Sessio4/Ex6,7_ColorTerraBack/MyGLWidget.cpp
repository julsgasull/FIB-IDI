...
MyGLWidget::MyGLWidget (QWidget* parent) : QOpenGLWidget(parent), program(NULL)
{
	...
	redColorBack = 64.0/255.0; 	greenColorBack = 63.0/255.0; 	blueColorBack = 76.0/255.0;
	//redColorBack = 0.5; 	greenColorBack = 0.7; 	blueColorBack = 1.0;
}
