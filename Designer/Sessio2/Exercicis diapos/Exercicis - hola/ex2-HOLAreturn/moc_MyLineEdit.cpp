...
QT_MOC_LITERAL(3, 21, 13) // "processReturn"

    },
    "MyLineEdit\0sendText\0\0processReturn"
};
...
void MyLineEdit::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyLineEdit::sendText)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyLineEdit::sendText(const QString & _t1)
{
