...
void MyGLWidget::paintGL ()
{
  ...
  //-------VAO1 quadrat-------//
  glViewport (0, 0, width()/2/2, height()/2/2);
  ...
  //-------VAO2 triangle dreta-------//
  glViewport (width()/2/2, height()/2/2, width()/2/2, height()/2/2); 
  glBindVertexArray(VAO2); // Activem l'Array a pintar 
  glDrawArrays(GL_TRIANGLES, 0, 3);   // Pintem l'escena
  glBindVertexArray(0);   // Desactivem el VAO
  
  //-------VAO2 triangle sobre -------//
  glViewport (0, height()/2/2, width()/2/2, height()/2/2); 
  glBindVertexArray(VAO2); // Activem l'Array a pintar 
  glDrawArrays(GL_TRIANGLES, 0, 3);   // Pintem l'escena
  glBindVertexArray(0);   // Desactivem el VAO
  ...
  //-------VAO1 quadrat-------//
  glViewport (width()/2+0, height()/2+0, width()/2/2, height()/2/2);
  glBindVertexArray(VAO1); // Activem l'Array a pintar 
  glDrawArrays(GL_TRIANGLES, 0, 6);   // Pintem l'escena
  glBindVertexArray(0);   // Desactivem el VAO
  
  //-------VAO2 triangle dreta-------//
  glViewport (width()/2+width()/2/2, height()/2+height()/2/2, width()/2/2, height()/2/2); 
  glBindVertexArray(VAO2); // Activem l'Array a pintar 
  glDrawArrays(GL_TRIANGLES, 0, 3);   // Pintem l'escena
  glBindVertexArray(0);   // Desactivem el VAO
  
  //-------VAO2 triangle sobre -------//
  glViewport (width()/2+0, height()/2+height()/2/2, width()/2/2, height()/2/2); 
  glBindVertexArray(VAO2); // Activem l'Array a pintar 
  glDrawArrays(GL_TRIANGLES, 0, 3);   // Pintem l'escena
  glBindVertexArray(0);   // Desactivem el VAO
}
